...
void TableView::getAttributesInput(Table& obj) {
	...
	while (true) {
		...
		attributesVector.emplace_back(attributeName, attributeType, attributeConstraints);
...
void TableView::getForeignKeysInput(Table& obj) {
	...
	while (foreignKeyInsertion) {
		...
		foreignKeysVector.emplace_back(keyAttributeName, referencedTableName, referencedAttributeName, keyConstraints);
